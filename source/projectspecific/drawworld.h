...
//	glLightf(GL_LIGHT0,GL_QUADRATIC_ATTENUATION,0.005f);
 ...
 if (i>=0 && i<4){
	switch(door_array[i][3]){
			case 2:
				glTranslatef(door[i].xpos-4.25,door[i].ypos-4,door[i].zpos-2.75);            //4.25             //glTranslatef(ex_x,ex_y,ex_z);
			...
			break; 
			case 1:
				glTranslatef(door[i].xpos-2.35,door[i].ypos-4,door[i].zpos-4);                         //glTranslatef(ex_x,ex_y,ex_z);
				glRotatef(door[i].xang,1,0,0);
				glRotatef(door[i].zang,0,0,1);
				...
				break;
			case 0:
				glTranslatef(door[i].xpos+3.5,door[i].ypos-4,door[i].zpos+2.85);                         //glTranslatef(ex_x,ex_y,ex_z);
				glRotatef(door[i].xang,1,0,0);
				glRotatef(door[i].zang,0,0,1);
				...
				break;
			case 3:
				glTranslatef(door[i].xpos-2.5,door[3].ypos-4,door[3].zpos+4);                         //glTranslatef(ex_x,ex_y,ex_z);
				glRotatef(door[i].xang,1,0,0);
				glRotatef(door[i].zang,0,0,1);
      ...
      else if(i>=4)
{
		switch(door_array[i][3]){
			case 2:
				glTranslatef(door[i].xpos+4.25,door[i].ypos-4,door[i].zpos-2.40);            //4.25             //glTranslatef(ex_x,ex_y,ex_z);
				glRotatef(door[i].xang,1,0,0);
				glRotatef(door[i].zang,0,0,1);
				glRotatef(door[i].yang+180,0,1,0);
				glTranslatef(0,0,-2); 
			break; 
			case 1:
				glTranslatef(door[i].xpos-2.45,door[i].ypos-4,door[i].zpos+4);                         //glTranslatef(ex_x,ex_y,ex_z);
				glRotatef(door[i].xang,1,0,0);
				glRotatef(door[i].zang,0,0,1);
				glRotatef(door[i].yang+270,0,1,0);
				glTranslatef(0,0,-2);
				break;
			case 0:
				glTranslatef(door[i].xpos-4.25,door[i].ypos-4,door[i].zpos+2.40);                         //glTranslatef(ex_x,ex_y,ex_z);
				glRotatef(door[i].xang,1,0,0);
				glRotatef(door[i].zang,0,0,1);
				glRotatef(door[i].yang,0,1,0);
				glTranslatef(0,0,-2);
        ...
        glVertexPointer(3,GL_FLOAT,sizeof(InterleavedVertex),&entityinterleavedvertex[door[i].type]->px);
		glTexCoordPointer(2,GL_FLOAT,sizeof(InterleavedVertex),&entityinterleavedvertex[door[i].type]->tx);
		glNormalPointer(GL_FLOAT,sizeof(InterleavedVertex),&entityinterleavedvertex[door[i].type]->nx);
